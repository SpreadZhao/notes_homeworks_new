...
数据线宽度就是CPU的数据线有多少个bit，比如32位的CPU数据线宽度就是32bit；而总线工作频率一般就是只干活的频率。[[Networking/dn#^84ab18|频率就是一秒扑腾的次数]]，而每次我们的扑腾能传n bit。所以将他们乘起来就是我们常见的bps。
...
![[Computer Structure/resources/Pasted image 20230308205043.png|400]]

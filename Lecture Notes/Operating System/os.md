...
![[Lecture Notes/Operating System/img/intelcpu.png|300]]
...
![[Lecture Notes/Operating System/img/processmodel.png]]

### 1.8 Process State

![[Lecture Notes/Operating System/img/processstate.png]]
...
![[Lecture Notes/Operating System/img/myfvkylin.png|100]]

  >
  > **注意：子进程从fork返回处开始执行**
  >
  > #question/class 子进程的PID是0是不是因为从返回处开始执行，导致没有初始化呢？（普通中断/缺页中断）
  >
  > Another example 
  >
  > ```c
...
* Execl
  ...
  > Result
  >
  > ![[Lecture Notes/Operating System/img/execl.png]]
...
* Killed by another process (involuntary) **谋杀**
  ...
  >Result
  >
  >![[Lecture Notes/Operating System/img/fatalerror.png]]
  >
  >Reason
  >
  ...
  >* 当`kill -9 3539`后的状态
  >
  >  ![[Lecture Notes/Operating System/img/kill3539.png]]
  >
  >* 与此同时，看到3539变为僵尸态
  >
  >  ![[Lecture Notes/Operating System/img/3539zb.png]]
  >
  >现在有俩进程，3700的父进程是3699
  >
  >* 若`kill -9 3699`(也就是把孩子他爸干掉)会
  >
  >  ![[Lecture Notes/Operating System/img/kill3699.png]]
  >
  >* 与此同时，发现这个孩子被1号进程接管
  >
  >  ![[Lecture Notes/Operating System/img/adopted.png]] ^467bf0
...
* PCB里的内容
  ...
  ![[Lecture Notes/Operating System/img/pcbcontent.png]]

### 1.9 Process Model Implementation

#### 1.9.1 Process Switching

![[Lecture Notes/Operating System/img/psswitch.png]]
...
![[Lecture Notes/Operating System/img/threadhaha.png]]
...
![[Lecture Notes/Operating System/img/threadmodel.png]]

### 2.4 Why Thread?

1. 在一个application里有多个活动，其中一些会block，这时把app分成几个能并行的顺序线程，模型会更简单
2. Thread比Process更容易创建/消除
3. ![[Lecture Notes/Operating System/img/whythread3.png]]
...
![[Lecture Notes/Operating System/img/tcb.png]]

* Three Implementation Way

  1. In User Space

![[Lecture Notes/Operating System/img/tinus.png]]
...
#question/class 线程切换不需要靠系统调用来实现吗？如果要靠系统调用的话，不是还需要陷入到内核空间中吗？
...
![[Lecture Notes/Operating System/img/howsyscall.png]]
  
  2. In Kernel Space
  
![[Lecture Notes/Operating System/img/tinks.png]]
  
* 创建Thread要用系统调用，进入Kernel Space
* Process Table保存每个Process的状态等

![[Lecture Notes/Operating System/img/tinkspb.png]]
  
  3. Hybrid
  
![[Lecture Notes/Operating System/img/thybrid.png]]
  
![[Lecture Notes/Operating System/img/thbdpb.png]]

### 2.6 POSIX Thread-学会！

* IEEE定义的线程包：pthread

![[Lecture Notes/Operating System/img/tphread.png]]
...
![[Lecture Notes/Operating System/img/pptd.png]]

![[Lecture Notes/Operating System/img/pptd2.png]]
...
![[Lecture Notes/Operating System/img/rccd.png]]
...
![[Lecture Notes/Operating System/img/strictat.png]]

         >**缺点：2个Process/Thread的顺序是固定的，TURN有个初值，则一定是某一个人先来**

      2. Peterson's solution

![[Lecture Notes/Operating System/img/ptsolu.png]]

![[Lecture Notes/Operating System/img/tsl.png]]

      4. Another TSL - XCHG(Intel)

![[Lecture Notes/Operating System/img/xchg.png]]
...
![[Lecture Notes/Operating System/img/semacode.png]]
      >
      >Result
      >
![[Lecture Notes/Operating System/img/semares.png]]

  2个Process和Semaphore
  
![[Lecture Notes/Operating System/img/twosem.png]]
  
  使用GDB调试
  
![[Lecture Notes/Operating System/img/semgdb.png]]
  ...
  * Mutex: Simplified Semaphore
    ...
    #question/class linuxStudy/mutex.c为什么两个in？

    Example

    ![[Lecture Notes/Operating System/img/mutexex.png]]
...
* Mutex Other: Conditional Variables
  ...
  ![[Lecture Notes/Operating System/img/cdvb.png]]
  
  ![[Lecture Notes/Operating System/img/cdvb2.png]]
  ...
  * Monitor
    ...
    >What is Dead lock?
    >
    >![[Lecture Notes/Operating System/img/ddlk.png]]
    >
    >结论：
  >
  >​	**使用Semaphore要小心**
...
![[Lecture Notes/Operating System/img/fcfsgc.png]]
...
![[Lecture Notes/Operating System/img/sjfnpgc.png]]
...
![[Lecture Notes/Operating System/img/sjfpgc.png]]
...
![[Lecture Notes/Operating System/img/rr.png]]

#### 4.4.2 Priority Scheduling

![[Lecture Notes/Operating System/img/prioritysc.png]]

#### 4.4.3 Multiple Queue

![[Lecture Notes/Operating System/img/mqueue.png]]
...
#question/class 为啥实现在Kernel Space进行线程调度的开销大呢？不是应该取决于我这个线程放在用户空间还是内核空间吗？如果线程本来就是放在内核空间的，那么在内核空间调度内核空间的线程花费应该是更少的吧
...
![[Lecture Notes/Operating System/img/eatf.png]]
...
![[Lecture Notes/Operating System/img/raw.png]]
...
![[Lecture Notes/Operating System/img/noma.png]]
...
>
> ![[Lecture Notes/Operating System/img/sr.png]]
...
![[Lecture Notes/Operating System/img/dyrc.png]]
...
![[Lecture Notes/Operating System/img/swap.png]]
...
![[Lecture Notes/Operating System/img/drp.png]]

#### 6.1.4 Free Space Management(**Dynamic**)

* bit map & list

![[Lecture Notes/Operating System/img/bl.png]]

* 对于list的升级：List Management

  当X结束时，更改List

![[Lecture Notes/Operating System/img/gglist.png]]
...
![[Lecture Notes/Operating System/img/mmu.png]]
...
![[Lecture Notes/Operating System/img/paging.png]]

#### **6.2.2 Virtual Address Translation**

![[Lecture Notes/Operating System/img/vat.png]]
...
![[Lecture Notes/Operating System/img/vat2.png]]
     >
...
![[Lecture Notes/Operating System/img/pta.png]]
...
* TLB：转换检测缓冲区(Translation Lookaside Buffer)
  ...
  >
![[Lecture Notes/Operating System/img/tlb.png]]

Multilevel Page Tables

![[Lecture Notes/Operating System/img/mpt.png]]

Inverted Table

![[Lecture Notes/Operating System/img/ip.png]]
...
![[Lecture Notes/Operating System/img/opr.png]]
...
![[Lecture Notes/Operating System/img/lru.png]]

  LRU另一种图解

![[Lecture Notes/Operating System/img/lruan.png]]

  使用硬件模拟LRU

![[Lecture Notes/Operating System/img/lruhd.png]]
...
![[Lecture Notes/Operating System/img/lif.png]]
...
![[Lecture Notes/Operating System/img/cpr.png]]
...
![[Lecture Notes/Operating System/img/wspr.png]]

* WSClock = Clock + Working Set

![[Lecture Notes/Operating System/img/wscpr.png]]
...
![[Lecture Notes/Operating System/img/sc.png]]
...
![[Lecture Notes/Operating System/img/lg.png]]

> **Age: 上次访问的时刻，越小表示越久没用了**

#### 6.3.2 Page Fault Frequency(PFF)

![[Lecture Notes/Operating System/img/pff.png]]
...
* **Page Size**
  ...
  * p/2：在最后一个Page通常占不满
  ...
  > E = \[1 / (p + 1)\] * (0 + 1 + ... + p) = p/2
  >
  > #question/common 为什么se/p不判一下s/p的余数是否为0
...
![[Lecture Notes/Operating System/img/sas.png]]

但是不够咋办？

比如16位机子上，分成了Ispace，Dspace

![[Lecture Notes/Operating System/img/isds.png]]
...
![[Lecture Notes/Operating System/img/shmget.png]]

  > 查看：**ipcs**

* Write: shmat(Shared Memory Attach)

![[Lecture Notes/Operating System/img/shmat.png]]

* Read

![[Lecture Notes/Operating System/img/shmrd.png]]
...
![[Lecture Notes/Operating System/img/sl.png]]

**注：编译时，库里的应是<u>相对地址</u>**

![[Lecture Notes/Operating System/img/sl2.png]]
...
![[Lecture Notes/Operating System/img/fwfile.png]]
...
![[Lecture Notes/Operating System/img/open.png]]
...
![[Lecture Notes/Operating System/img/ib.png]]

**前面说的CISC会有以下问题：**

![[Lecture Notes/Operating System/img/ciscpb.png]]
...
![[Lecture Notes/Operating System/img/bs.png]]
...
![[Lecture Notes/Operating System/img/sopam.png]]
...
![[Lecture Notes/Operating System/img/multics.png]]
...
![[Lecture Notes/Operating System/img/st.png]]
...
![[Lecture Notes/Operating System/img/fnex.png]]
...
![[Lecture Notes/Operating System/img/exeac.png]]

> **Magic number: 标识符，表示程序是可执行的**
>
> archive: 库，档案
>
> #question/class 为什么有的程序就几行，却把整个库都链上了？

展示：普通文件和目录文件

在linux下执行`ll`命令

![[Lecture Notes/Operating System/img/ll.png]]
...
> * '-' 代表普通文件
>
> #question/class 这里显示的目录文件为啥是文件夹？

Device file下的block device file和character device file

进入`/dev`目录，使用`ll`命令

![[Lecture Notes/Operating System/img/devll.png]]
...
![[Lecture Notes/Operating System/img/loop1.png]]
...
![[Lecture Notes/Operating System/img/fa.png]]
...
![[Lecture Notes/Operating System/img/tkfs.png]]
...
![[Lecture Notes/Operating System/img/sld.png]]

* Contains 4 files
* Owned by 4 different people: A, B, C and D

![[Lecture Notes/Operating System/img/sld2.png]]
...
![[Lecture Notes/Operating System/img/dld.png]]

* 每个用户一个文件夹

#### 7.3.3 Hierarchical Directory

![[Lecture Notes/Operating System/img/hd.png]]
...
![[Lecture Notes/Operating System/img/dtree.png]]
...
![[Lecture Notes/Operating System/img/sln.png]]
...
![[Lecture Notes/Operating System/img/ca.png]]
...
![[Lecture Notes/Operating System/img/llcun.png]]

> * 这么存，随机访问很慢，每次都要从表头一个一个搜索，改进 -> FAT

##### 7.4.1.3 FAT(File Allocation Table)

![[Lecture Notes/Operating System/img/fat.png]]
...
![[Lecture Notes/Operating System/img/inode.png]]
...
![[Lecture Notes/Operating System/img/fxsize.png]]
...
![[Lecture Notes/Operating System/img/ipr.png]]
...
>
> ![[Lecture Notes/Operating System/img/lsisln.png]]
>
> 再看一下s.c的编号
>
> ![[Lecture Notes/Operating System/img/lsis.png]]
>
> * **这个就是软连接-soft**
...
![[Lecture Notes/Operating System/img/hl.png]]

和s.c一样，所以硬链接创建的是同一个文件

![[Lecture Notes/Operating System/img/hli.png]]

> 问题：


![[Lecture Notes/Operating System/img/link.png]]
...
![[Lecture Notes/Operating System/img/fsl.png]]
...
* Super Block里放一些文件系统的关键参数，比如前面说的Physical Block，那一个块有多大呢？Inode的区域(就是后面那块)的起始地址在哪？或者这是啥文件系统呢？是ext3，ext4，还是ntfs之类的？在我的[[Homework/Data Management/5. ext_fs#5. EXT文件系统结构|数据管理技术课程调研报告]]中有补充。
...
![[Lecture Notes/Operating System/img/pavs.png]]

![[Lecture Notes/Operating System/img/vfa.png]]
...
![[Lecture Notes/Operating System/img/ktfb.png]]

![[Lecture Notes/Operating System/img/kt2.png]]

有些用户会恶意写垃圾数据，因此需要做一些限制：Quota table(配额表)

![[Lecture Notes/Operating System/img/qtt.png]]
...
* File limit
  ...
  >
  > #question/class 那个表里是Open file table里的QuotaPointer，那么是每一个用户对应一张Quota table，还是每一个文件都有一张Quota table呢？我感觉是每个用户一张，然后不同的Open file table中正在打开的文件，每个里面的Quota pointer，只要User是那个User，那pointer指向的就是同一张Quota table

#### 7.5.2 File System Reliability

增量式备份(incremental dump)：当修改文件时，不拷贝整个文件系统，只拷贝修改过的文件

![[Lecture Notes/Operating System/img/dump.png]]
...
![[Lecture Notes/Operating System/img/sd.png]]
...
![[Lecture Notes/Operating System/img/cache.png]]
...
![[Lecture Notes/Operating System/img/cid.png]]
...
![[Lecture Notes/Operating System/img/iso.png]]
...
![[Lecture Notes/Operating System/img/msdos.png]]
...
![[Lecture Notes/Operating System/img/unixv7.png]]
...
![[Lecture Notes/Operating System/img/uxi.png]]

> 最后三个槽位都是扩展槽位

![[Lecture Notes/Operating System/img/usc.png]]
...
![[Lecture Notes/Operating System/img/std.png]]
...
![[Lecture Notes/Operating System/img/smi.png]]

  > 需要用特殊指令加上地址，表示访问的是IO space

* Memory-Mapped I/O

![[Lecture Notes/Operating System/img/mmi.png]]

  > 不管在内存还是IO，用一种指令就行，比如MOVE

* Hybrid

![[Lecture Notes/Operating System/img/hy.png]]
...
#question/class 那这个图里的IO空间的地址是实地址还是虚地址？如果是虚地址，那比如我写一个程序要控制IO，那在这个程序的进程执行的时候，要创建一个虚地址空间，如果采用的是统一编址，那是不是会有某种特定的算法来讲这个内存的虚地址和IO的虚地址区分开呢？
...
![[Lecture Notes/Operating System/img/algo.png]]

* 在上面的基础上，CPU和MM之间搭了一根高速总线

![[Lecture Notes/Operating System/img/gs.png]]
...
![[Lecture Notes/Operating System/img/dma.png]]
...
![[Lecture Notes/Operating System/img/it.png]]
...
![[Lecture Notes/Operating System/img/layer.png]]
...
![[Lecture Notes/Operating System/img/jk.png]]

**Device-Independent I/O Software**

![[Lecture Notes/Operating System/img/fi.png]]
...
![[Lecture Notes/Operating System/img/hc.png]]

> TCP-IP网卡，不管是啥牌子的网卡，都可以用Socket做

关于其中的Buffering

![[Lecture Notes/Operating System/img/bf.png]]
...
![[Lecture Notes/Operating System/img/cppb.png]]
...
![[Lecture Notes/Operating System/img/zlc.png]]
...
![[Lecture Notes/Operating System/img/pt.png]]
...
![[Lecture Notes/Operating System/img/td.png]]

* Server disk and PC disk: Server的更贵，存储密度低，通常一个文件分散在多个硬盘上，可以多个硬盘一块儿读，效率高

新老硬盘对比

![[Lecture Notes/Operating System/img/no.png]]
...
![[Lecture Notes/Operating System/img/raid.png]]
...
![[Lecture Notes/Operating System/img/ds.png]]
...
![[Lecture Notes/Operating System/img/df.png]]
...
![[Lecture Notes/Operating System/img/ssf.png]]

> 假设现在在11，然后读11的时候，来了一堆请求 ，要读12,9,16,1,34，那就看这几个里谁离11最近读谁，那就是12，然后再看剩下的谁离12最近，9，所以读9……然后算seek motion就是看11读12挪了1,12读9挪了3

Elevator

![[Lecture Notes/Operating System/img/ele.png]]

> 就和坐电梯一样，只能往一个方向走，只有目的地都在另一边时才转向

**Error handling**

![[Lecture Notes/Operating System/img/eh.png]]

> 有保留扇区，如果第七块坏了，就把保留扇区替换那块坏的，号还是7

**CD-ROM**

![[Lecture Notes/Operating System/img/cdr.png]]

* 比如有坑是0，凸起是1，那就能存数据了

**Stable Storage**

![[Lecture Notes/Operating System/img/ss.png]]
...
![[Lecture Notes/Operating System/img/cl.png]]

> Crystal oscillator：发射方波，发一个Counter减一下，减到0后就发一个中断

**Soft Timer**

![[Lecture Notes/Operating System/img/scl.png]]
...
![[Lecture Notes/Operating System/img/ter.png]]
...
![[Lecture Notes/Operating System/img/sm.png]]

**GUI Software**

![[Lecture Notes/Operating System/img/gui.png]]
...
![[Lecture Notes/Operating System/img/xw.png]]

> **Exercise: **虚拟机Linux，然后Windows上下X Window程序，然后"远程"连接虚拟机

**Power Management**

![[Lecture Notes/Operating System/img/pm.png]]

> 显示器省电，window1要显示要点亮9块，那把它移到左上角，就只点亮4块了

![[Lecture Notes/Operating System/img/pmc.png]]
...
* Mutual exclusion condition
  ...
  >
  > #question/common 这句话是不是说了和没说一样，改成：有人正在访问关键区是不是更好呢？
...
![[Lecture Notes/Operating System/img/cir.png]]
...
![[Lecture Notes/Operating System/img/dd.png]]

> 使用离散数学中的环，如果有环，那这个程序就有可能会产生Deadlock

**每种资源有多个**

![[Lecture Notes/Operating System/img/dd2.png]]
...
![[Lecture Notes/Operating System/img/lz.png]]
...
![[Lecture Notes/Operating System/img/dilei.png]]
...
![[Lecture Notes/Operating System/img/su.png]]
...
![[Lecture Notes/Operating System/img/bks.png]]

* a：随便走都能分完，一次分一个就行，safe
* b：先给c，然后给b或者d，然后……也是safe
* c：不管咋给都不行，unsafe

![[Lecture Notes/Operating System/img/bks2.png]]
...
![[Lecture Notes/Operating System/img/cw.png]]
...
![[Lecture Notes/Operating System/img/mp.png]]

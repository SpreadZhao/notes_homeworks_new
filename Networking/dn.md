...
### 19.5 Routing Information Protocol

在介绍RIP之前，我们要介绍Distance-Vector(DV) Routing。而介绍DV之前，还要介绍Bellman-Ford算法。这个算法就是用来求节点之间花费最小的路径的。比如在图中有两个节点x和y，我们需要知道，从x到y哪条路径是花费最小的呢？那这个最小路径可以表示成$D_{xy}$。那么Bellman-Ford算法服从下面的思想：
